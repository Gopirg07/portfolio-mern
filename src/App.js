          ...
          <div className="projects-wrap">
            ...
            <div className="row project-each shadow">
              ...
              <div className="project-text col-lg-4">
                ...
                <p className="project-exp">
                  ...
                  For Now Its Limited To Only Create Leads & Contacts.{" "}
                </p>
                ...
                <div className="project-view">
                  <a className="view" target="_blank" href="https://github.com/Gopirg07/crm-frontend">
                    {" "}
                    Code <GitHubIcon />{" "}
                  </a>
                  <a className="view" target="_blank" href="https://gcrm-frontend.netlify.app/">
                    {" "}
            ...
            <div className="row project-each shadow">
              ...
              <div className="project-text col-lg-4">
                ...
                <div className="project-view">
                  <a className="view" target="_blank" href="https://github.com/Gopirg07/recap-dashboard">
                    {" "}
                    Code <GitHubIcon />{" "}
                  </a>
                  <a className="view" target="_blank" href="https://bejewelled-sundae-e95c38.netlify.app/">
                    {" "}
                    Live Demo <OpenInNewRoundedIcon />{" "}
                  </a>
                </div>
            ...
            <div className="row project-each shadow">
              ...
              <div className="project-text col-lg-4">
                ...
                <p className="project-exp">
                  ...
                  Api For My Webcode Project. In This Api Project We Can Search
                  Any Makeup products By The Product Type,Product
                  Category,Product Tags,Brand,etc.. For Now Its Limited To Search By Only
                  Product Type.
                </p>
                <div className="project-skills">
                ...
                <div className="project-view">
                  <a className="view" target="_blank" href="https://github.com/Gopirg07/Hackathon-1">
                    {" "}
                    Code <GitHubIcon />{" "}
                  </a>
                  <a className="view" target="_blank" href="https://admirable-torte-98f637.netlify.app/">
                    {" "}
                    Live Demo <OpenInNewRoundedIcon />{" "}
                  </a>
                </div>
